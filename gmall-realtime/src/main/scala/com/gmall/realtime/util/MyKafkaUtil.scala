...
object MyKafkaUtil {
  ...
  // kafka 主题，StreamingContext，groupid
  ...
  // kafka 主题，StreamingContext，offset 偏移量，groupid
  // 手动加载偏移量，不加的话就是最新记载的位置
  // Map[TopicPartition,Long] 所在分区对应的偏移量，不同的消费者组
